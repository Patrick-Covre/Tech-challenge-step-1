...
def test_log_sklearn_run(mock_mlflow):
    ...
    mock_mlflow.sklearn.log_model.assert_called_once_with(
        mock_model,
        artifact_path="my_sklearn_model",
...
def test_log_pytorch_run(mock_mlflow):
    ...
    mock_mlflow.pytorch.log_model.assert_called_once_with(
        mock_model,
        artifact_path="my_pytorch_model",
        registered_model_name=None
    )
...
def test_configure_registered_version(mock_mlflow, mock_client_class):
    ...
    mock_client.update_registered_model.assert_called_once_with("my_model", description="Model Description")
    mock_client.update_model_version.assert_called_once_with("my_model", "2", description="Version Description")
    mock_client.set_model_version_tag.assert_called_once_with("my_model", "2", "stage", "production")
