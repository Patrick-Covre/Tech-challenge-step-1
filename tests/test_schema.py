...
raw_schema = DataFrameSchema(
    columns={
        ...
        "PhoneService": Column(str, Check.isin(["Yes", "No"]), required=True),
            ...
            "OnlineSecurity": Column(str, Check.isin(["No", "No internet service", "Yes"]), required=True),
            "OnlineBackup": Column(str, Check.isin(["No", "No internet service", "Yes"]), required=True),
            "DeviceProtection": Column(str, Check.isin(["No", "No internet service", "Yes"]), required=True),
            ...
            "StreamingMovies": Column(str, Check.isin(["No", "No internet service", "Yes"]), required=True),
        "Contract": Column(str, Check.isin(["Month-to-month", "One year", "Two year"]), required=True),
        "PaperlessBilling": Column(str, Check.isin(["Yes", "No"]), required=True),
        "PaymentMethod": Column(str, Check.isin(["Bank transfer (automatic)", "Credit card (automatic)", "Electronic check", "Mailed check"]), required=True),
